...
public class Dijkstra {
    ...
    private static Node minDistanceNode(Set<Node> unfineshedNodes) {
    ...
    public static void shotestDistance(Graph graph, String filePath) {
    ...
    public static void shotestTime(Graph graph, String filePath) {
        In in2 = new In(filePath);
        String[] arr2 = in2.readAllLines();
        for (int i = 1; i < arr2.length; i++) {
            Node nodeA = new Node(arr2[i].split(";")[1]);
